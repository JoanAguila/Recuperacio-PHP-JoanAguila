            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">   
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/arrays">Arrays</a>
                            </li>                
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/GET">GET</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/POST">POST</a>
                            </li>                           
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/cookies">Cookies</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/sessions">Sessions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/PDO">PDO</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/portafoli-personal-php/pages/EXTRA">EXTRA</a>
                            </li>
                    ...
                    <ul class="navbar-nav ms-auto">                 
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/portafoli-personal-php/auth/desconectar.php">
                                       Logout
                                    </a>                                   
                                </div>
                            </li>
